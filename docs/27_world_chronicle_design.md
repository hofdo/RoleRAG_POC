...
tags and provenance are this design's substrate. Backlog items: **#81–#83**.
...
The LLM's influence ends at the tags it already wrote during play, and making those tags
trustworthy is exactly what the docs/26 fold/pinning work does. If a future variant wants
LLM-written chronicle prose, that is a new design conversation, not an extension of this
one.
...
- **A new LLM call site** — promotion is pure selection (§3.2).
